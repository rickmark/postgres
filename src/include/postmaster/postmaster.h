...
extern PGDLLIMPORT bool enable_xpc;
extern PGDLLIMPORT char *xpc_service_name;
extern PGDLLIMPORT char *xpc_client_teamid;
extern PGDLLIMPORT char *xpc_client_bundleid;
extern PGDLLIMPORT char *xpc_client_requirement;
